...
Production S3 bucket/delivery details, acceptable maximum feed age and ad hoc incremental delivery remain unconfirmed. They do not block the implemented planner. Complete national live-feed coverage and itinerary saving/tracking remain later work.
