...
export function registerAdminRoutes(app, { plannerService } = {}) {
    registerPlannerSearchAdminRoutes(app, { listSearches: plannerService?.listSearches
        ? query => plannerService.listSearches(query) : listPlannerSearchLogs, renderShell: renderAdminShell,
        clearSearchCache: plannerService ? () => plannerService.clearSearchCache() : undefined,
        plannerTargets: plannerService?.describe ? plannerService : undefined });
